  ...
  <img src='https://upload.wikimedia.org/wikipedia/commons/b/b1/Rick_and_Morty.svg'></img>
     ...
     <div className="contains">
      ...
      <div className =" formEmail">
        ...
        {errors.e3 ? <p style={{color:"red"}}>It cannot have more than 25 characters ✖</p> : <p style={{color:" rgb(17, 80, 119)"}}>It cannot have more than 25 characters ✔</p>}
        </div>
        </div>
      <br></br>
        ...
        /><div className="passErrors">
         {errors.p1 ? <p style={{color:"red"}}>It must have at least one number ✖</p> : <p style={{color:"rgb(17, 80, 119)"}}>It must have at least one number ✔</p>}
